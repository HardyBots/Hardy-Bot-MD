...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Hardy-Bot-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['TheMystic-Bot-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
auth: {
creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `[ ⏳ ] Uptime: ${uptime} | Created by Aymane Touzani`;
